#
# Module manifest for module 'PSTest'
#
...
@{
    ...
    GUID              = '5cc5cf7d-8dc5-48b0-9dd1-2b0f30c5e777'
    ...
    Description       = 'A Libarary for PSTest - A simple testing suite for powershell cmdlets and functions.'
    ...
    #NestedModules = @('lib\PSTestResult.psm1')
    ...
    #ModuleList = @('lib\PSTestResult.psm1')
    ...
    HelpInfoURI       = 'https://github.com/jimurrito/PSTest'
